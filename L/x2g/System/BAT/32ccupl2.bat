...
L:\x2g\3rdparty\dosbox\dosbox.exe -noconsole -conf "L:\x2g\SYSTEM\BAT\dosbox_L.conf" -c "@cd L:\x2g\3rdparty\ccupload\" -c "@L:\x2g\SYSTEM\BAT\DBccupld.bat %1 %2 %3 %4 2 %6 %7"
