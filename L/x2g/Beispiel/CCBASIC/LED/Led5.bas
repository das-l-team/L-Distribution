...
#loop1
  ...
  if changedtemp then gosub outputtemp  ' neu!!! Abfrage eines Rueckgabewertes
  tempold = temp
  pause 10

loop1                            ' neu!!! goto kann entfallen

#loop2

  if changedtime then gosub outputtime  ' neu!!! Abfrage eines Rueckgabewertes
  tempold = temp
  pause 10

loop2                            ' neu!!! goto kann entfallen
...
#changedtemp
return  min <> tempold         ' neu!!! Rueckgabewerte von Unterfunktionen
